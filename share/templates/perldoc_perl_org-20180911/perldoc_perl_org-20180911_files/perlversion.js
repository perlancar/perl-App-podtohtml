...
document.write('  <optgroup label="Perl 5 version 26">');
document.write('    <option value="/index.html">Perl 5.26.1');
document.write('    <option value="/5.26.0/index.html">Perl 5.26.0');
document.write('  </optgroup>');
document.write('  <optgroup label="Perl 5 version 24">');
document.write('    <option value="/5.24.0/index.html">Perl 5.24.0');
document.write('  </optgroup>');
document.write('  <optgroup label="Perl 5 version 22">');
document.write('    <option value="/5.22.0/index.html">Perl 5.22.0');
document.write('  </optgroup>');
